...
namespace BookStoreDbFirst.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Price,AuthorId,PublisherId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Price,AuthorId,PublisherId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
